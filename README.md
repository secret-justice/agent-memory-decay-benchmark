...
©À©¤©¤ src/
©¦   ©¸©¤©¤ gate/
©¦       ©À©¤©¤ lnn_model.py           # LTC gate architecture
©¦       ©À©¤©¤ memory_gate.py         # Gate integration with memory retrieval
©¦       ©¸©¤©¤ lnn_trainer.py         # Gate training and evaluation
©À©¤©¤ os_agent_system/
©¦   ©À©¤©¤ gate/                      # LTC gate (production version)
©¦   ©À©¤©¤ memory/                    # Memory management (forgetting curve, tiers, manager)
©¦   ©À©¤©¤ search/                    # BM25 + hybrid search engine
©¦   ©À©¤©¤ knowledge/                 # Knowledge engine (24-type conflict detection)
©¦   ©À©¤©¤ extraction/                # Zero-LLM pipeline
©¦   ©¸©¤©¤ security/                  # Sensitive filter (PII/security)
©À©¤©¤ experiments/
©¦   ©À©¤©¤ v21_c0_fix.py              # C0 fix: Exp-1 (regression) + Exp-2 (balanced) + Exp-3 (ranking)
©¦   ©À©¤©¤ v21_c0_exp3_only.py        # Exp-3 standalone (memory-efficient)
©¦   ©À©¤©¤ v21_c0_fix_efficient.py    # Lightweight version
©¦   ©À©¤©¤ exp_personachat.py         # PersonaChat experiments
©¦   ©À©¤©¤ exp_lpt.py                 # LPT experiments
©¦   ©À©¤©¤ run_stress_tests.py        # Stress tests (Exp48-60)
©¦   ©¸©¤©¤ _exp*_*.py                 # Additional experiments
©À©¤©¤ data/
©¦   ©À©¤©¤ personachat_enhanced.json  # PersonaChat dataset (100 users, 8 categories)
©¦   ©¸©¤©¤ lpt_200users.json          # LPT dataset (200 users, 5 categories)
©À©¤©¤ results/
©¦   ©À©¤©¤ v21_c0_fixed_results.json  # Complete 3-experiment results (Exp-1/2/3)
©¦   ©À©¤©¤ v21_c0_exp3_results.json   # Exp-3 ranking results
©¦   ©À©¤©¤ personachat_results.json   # PersonaChat baseline results
©¦   ©À©¤©¤ lpt_results.json           # LPT baseline results
©¦   ©À©¤©¤ results_exp38_47.json      # Module coverage experiments
©¦   ©À©¤©¤ results_exp48_55.json      # Adversarial experiments
©¦   ©À©¤©¤ results_exp56_60.json      # Targeted experiments
©¦   ©À©¤©¤ results_stress.json        # Stress test results
©¦   ©¸©¤©¤ results_m1_ablation.json   # Gate ablation results
©À©¤©¤ figures/                       # Paper figures (12 PNG files)
©À©¤©¤ supplementary/
©¦   ©À©¤©¤ v22_PeerJCS.docx           # Paper manuscript (PeerJ CS format)
©¦   ©À©¤©¤ v22_peerj_paragraphs.txt   # Paper text (for programmatic access)
©¦   ©À©¤©¤ v22_self_review.md         # Self-review report
...
### Install
```bash
git clone https://github.com/secret-justice/agent-memory-decay-benchmark.git
